      ...
      <div className="page-container">
        ...
        <div className="card">
          ...
          <form className="form-grid" onSubmit={handlePayrollSubmit}>
            <input className="form-input" type="number" placeholder="Teacher ID" value={payrollForm.teacher_id} onChange={(e) => setPayrollForm({ ...payrollForm, teacher_id: e.target.value })} />
            <input className="form-input" placeholder="Month (YYYY-MM)" value={payrollForm.month} onChange={(e) => setPayrollForm({ ...payrollForm, month: e.target.value })} />
            <input className="form-input" type="number" placeholder="Base Salary" value={payrollForm.base_salary} onChange={(e) => setPayrollForm({ ...payrollForm, base_salary: e.target.value })} />
            ...
            <select className="form-input" value={payrollForm.status} onChange={(e) => setPayrollForm({ ...payrollForm, status: e.target.value })}>
              <option value="pending">Pending</option>
              <option value="processed">Processed</option>
              <option value="paid">Paid</option>
            </select>
            <input className="form-input" type="date" value={payrollForm.paid_on} onChange={(e) => setPayrollForm({ ...payrollForm, paid_on: e.target.value })} />
